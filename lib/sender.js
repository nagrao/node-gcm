...
var sendNoRetryMethod2 = Sender.prototype.sendNoRetry2 = function(message, registrationIds, callback) {
	...
	var post_options = {
  	...
  	var post_req = https.request(post_options, function(res) {
    	...
    	res.on('end', onEndClose);
    	res.on('close', onEndClose);
